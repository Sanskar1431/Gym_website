        ...
        <div className="page-padding py-[10rem] flex justify-center">
          ...
          >
            ...
            <div className="flex gap-4 items-center mt-16 min450:flex-col">
              <p className="text-white text-[1.5rem]">New to Weight Wearhouse gym?</p>
              <Link
                to="/signup"
            ...
            <p className="text-[#ffffffbc] text-[1.4rem] mt-3">
              <span className="text-[#FFD700]">Test Account</span> -
              weightwearhousegym@gmail.com <span className="text-[#FFD700]"> / </span>
              testpassword123
            </p>
          </form>
        </div>
