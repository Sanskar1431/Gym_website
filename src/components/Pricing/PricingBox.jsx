    ...
    <>
      <div className="flex flex-col w-1/3 md1000:w-[40rem] bg-white shadow-xl relative min540:w-[100%]">
        ...
        >
          ...
          <div className="absolute bg-white text-[20px] font-bold w-[25rem] text-center py-6 text-[#FFD700] -bottom-[18px] left-0 right-0 mx-auto">
            {title}
          </div>
        </div>
        <div className="flex flex-col items-center pt-[20px] pb-[50px]">
          ...
          <p className="text-center text-[55px] font-bold relative py-[10px] ">
            <span className="text-[30px] text-[#6d6d6d] absolute font-normal top-8 -left-[3.5rem]">
              {currency}
            </span>
            {price}
