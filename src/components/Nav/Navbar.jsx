      ...
      >
        ...
        <div className="flex items-center gap-10">
          <div className="flex gap-10">
            ...
            >
              <i
                ...
                className="fa-solid fa-xmark text-[#FFD700] text-[3.3rem] cursor-pointer self-end"
              ></i>
            ...
            <div>
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <img src={Logo} alt="logo_img" className="w-[8rem] h-[8rem] rounded-full object-cover" />
                  <i
                    onClick={sideBar}
                    className="fa-solid fa-xmark text-[#FFD700] text-[3.3rem] cursor-pointer"
                  ></i>
                </div>
                {/* about us */}
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#FFD700] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-location-dot text-[#FFD700]"></i>
                    &nbsp; Naya Gaon Chandpur Road B.S.R UP 203001
                  </p>
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#FFD700] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-phone text-[#FFD700]"></i>&nbsp;
                    +91 8077883305
                  </p>
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#FFD700] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-envelope text-[#FFD700]"></i>
                    &nbsp; weightwearhousegym@gmail.com
                  </p>
                </div>
                {/* follow us */}
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex gap-5">
                    <span className="bg-[#FFD700] rounded-full py-[12px] px-[17px] cursor-pointer">
            ...
            <i
              onClick={hamburgerMenu}
              className="fa-bars fa-solid hidden text-white text-4xl cursor-pointer hover:text-[#FFD700] ease-in duration-200"
            ></i>
            {/* account */}
            <Link onClick={goTop} to="/signup" title="signup_button">
              <i className="fa-regular fa-user  text-white text-4xl cursor-pointer hover:text-[#FFD700] ease-in duration-200"></i>
            </Link>
            {/* sidebar */}
            <i
              onClick={sideBar}
              className="fa-regular fa-chart-bar text-white text-4xl cursor-pointer hover:text-[#FFD700] ease-in duration-200"
            ></i>
          </div>
          {/* spin box */}
          <div className="border-[rgb(255,255,255,0.3)] border-solid border-2  p-2 rounded-md min620:hidden">
            ...
            >
              <i
                className={`fa-solid fa-plus bg-[#FFD700] text-white text-2xl py-3 px-4 rounded-md ${
                  spin ? "nav-btn-hover" : ""
                }`}
              ></i>
