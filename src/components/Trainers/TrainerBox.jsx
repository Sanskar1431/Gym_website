...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Shobit Rajput", job: "Personal Trainer" },
    { img: Trainer2, name: "Lata Thakur", job: "Girl's Trainer" },
    { img: Trainer3, name: "Robin Thakur", job: "Strength Trainer" },
  ];
